...
""" 
This source code has been created by modifying the expander.py file, 
which is publicly available at https://github.com/atcoder/ac-library/blob/master/expander.py.
"""
